      ...
      <View style={styles.headercontainer}>
        ...
        >
          ...
          <View style={styles.Imagecontainer}>
            <Text style={styles.Imagecontainertext}>Product-Ad</Text>
          </View>
        </LinearGradient>
      </View>
      <ScrollView>
        <View style={styles.guidetext}>
          <Text style={styles.guidetext1}>
            This AI is capable of performing tasks like Turning a product
            description into ad copy.
          </Text>
        </View>
        ...
        <View style={styles.view1}>
          <Text style={styles.guidetext2}>
            ...
            aimed at parents "Product: Learning Room is a virtual environment to
            help students from kindergarten to high school excel in school.""
          </Text>
          <TextInput
