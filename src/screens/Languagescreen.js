      ...
      <View style={styles.headercontainer}>
        ...
        >
          ...
          <View style={styles.Imagecontainer}>
            <Text style={styles.Imagecontainertext}>Translator</Text>
          </View>
        </LinearGradient>
      </View>
      <ScrollView>
        <View style={styles.guidetext}>
          <Text style={styles.guidetext1}>
            This AI is capable of performing tasks like Translates English text
        ...
        <View style={styles.view1}>
          <Text style={styles.guidetext2}>
            Translate this into French "What rooms do you have available?"
          </Text>
          <TextInput
