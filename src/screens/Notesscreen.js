      ...
      <View style={styles.headercontainer}>
        ...
        >
          ...
          <View style={styles.Imagecontainer}>
            <Text style={styles.Imagecontainertext}>Note-Summary</Text>
          </View>
        </LinearGradient>
      </View>
      <ScrollView>
        <View style={styles.guidetext}>
          <Text style={styles.guidetext1}>Notesscreen</Text>
          <Text style={styles.guidetext1}>
            This AI is capable of performing tasks like Turning meeting notes
            into a summary.
          </Text>
        </View>
        ...
        <View style={styles.view1}>
          <Text style={styles.guidetext2}>
            ...
            "Tom: Profits up 50% Jane: New servers are online Kjel: Need more
            time to fix software Jane: Happy to help Parkman: Beta testing
            almost done"
          </Text>
          <TextInput
