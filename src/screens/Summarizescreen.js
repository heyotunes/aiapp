      ...
      <View style={styles.headercontainer}>
        ...
        >
          ...
          <View style={styles.Imagecontainer}>
            <Text style={styles.Imagecontainertext}>Summarize-Text</Text>
          </View>
        </LinearGradient>
      </View>
      <ScrollView>
        <View style={styles.guidetext}>
          <Text style={styles.guidetext1}>
            This AI is capable of performing tasks like Translates difficult
        ...
        <View style={styles.view1}>
          <Text style={styles.guidetext2}>
            Summarize this for a second-grade student: upiter is the fifth
            planet from the Sun and the largest in the Solar System. It is a gas
            giant with a mass one-thousandth that of the Sun, but two-and-a-half
